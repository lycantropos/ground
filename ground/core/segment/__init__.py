...
from ground.core.enums import Orientation, Relation
from ground.core.hints import Point, ScalarT, TernaryPointFunction
...
plain_context: Context[Any] = Context(plain.intersect)
