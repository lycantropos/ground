...
def _adjusted_signed_area(first_start_x: Coordinate,
    ...
    result_expansion = sum_expansions(
            result_expansion, to_dot_product(first_dx_tail, second_dx_head,
                                             first_dy_tail, second_dy_head))
    result_expansion = sum_expansions(
            result_expansion, to_dot_product(first_dx_head, second_dx_tail,
                                             first_dy_head, second_dy_tail))
    result_expansion = sum_expansions(
            result_expansion, to_dot_product(first_dx_tail, second_dx_tail,
