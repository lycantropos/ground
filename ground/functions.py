...
_QuaternaryPointFunction = Callable[[_hints.Point, _hints.Point, _hints.Point,
                                     _hints.Point], _hints.Coordinate]
...
class Context:
    ...
    def __init__(self,
                 cross_producer: _QuaternaryPointFunction,
                 dot_producer: _QuaternaryPointFunction,
                 incircle_determiner: _QuaternaryPointFunction) -> None:
    ...
    @property
    def cross_producer(self) -> _QuaternaryPointFunction:
        return self._cross_producer

    @property
    def dot_producer(self) -> _QuaternaryPointFunction:
        return self._dot_producer

    @property
    def incircle_determiner(self) -> _QuaternaryPointFunction:
...
def to_cross_producer() -> _QuaternaryPointFunction:
    return get_context().cross_producer


def to_dot_producer() -> _QuaternaryPointFunction:
    return get_context().dot_producer


def to_incircle_determiner() -> _QuaternaryPointFunction:
