...
contexts_with_boxes = contexts_with_coordinates_strategies.flatmap(
    to_contexts_with(boxes_factory)
)
...
contexts_with_boxes_and_points = contexts_with_coordinates_strategies.flatmap(
    to_contexts_with(boxes_factory, points_factory)
)
...
contexts_with_points = contexts_with_coordinates_strategies.flatmap(
    to_contexts_with(points_factory)
)
...
contexts_with_rational_multipoints_and_scalars_pairs = (
    rational_contexts_with_coordinates_strategies.flatmap(
        to_contexts_with(multipoints_factory, itemgetter(1), itemgetter(1))
    )
)
...
contexts_with_rational_multipolygons_and_scalars_pairs = (
    rational_contexts_with_coordinates_strategies.flatmap(
        to_contexts_with(multipolygons_factory, itemgetter(1), itemgetter(1))
    )
)
...
contexts_with_rational_multisegments_and_scalars_pairs = (
    rational_contexts_with_coordinates_strategies.flatmap(
        to_contexts_with(multisegments_factory, itemgetter(1), itemgetter(1))
    )
)
...
contexts_with_points_pairs = contexts_with_coordinates_strategies.flatmap(
...
contexts_with_points_lists = contexts_with_coordinates_strategies.flatmap(
    to_contexts_with(
        compose(partial(st.lists, max_size=MAX_SEQUENCE_SIZE), points_factory)
    )
)
contexts_with_non_empty_points_lists = (
    contexts_with_coordinates_strategies.flatmap(
        to_contexts_with(
            compose(
                partial(st.lists, min_size=1, max_size=MAX_SEQUENCE_SIZE),
                points_factory,
            )
        )
    )
)
contexts_with_points_triplets = contexts_with_coordinates_strategies.flatmap(
...
contexts_with_segments_pairs = contexts_with_coordinates_strategies.flatmap(
    to_contexts_with(compose(to_pairs, segments_factory))
)
...
contexts_with_segments = contexts_with_coordinates_strategies.flatmap(
    to_contexts_with(segments_factory)
)
...
contexts_with_multipoints = contexts_with_coordinates_strategies.flatmap(
...
contexts_with_polygons = contexts_with_coordinates_strategies.flatmap(
    to_contexts_with(polygons_factory)
)
...
contexts_with_multipolygons = contexts_with_coordinates_strategies.flatmap(
    to_contexts_with(multipolygons_factory)
)
